...
const UI = {
  es: {
    ...
    'dengue.note': 'Datos congelados a mayo de 2026; los meses recientes son provisionales por el rezago de notificación. Manuscrito en preparación (De Arcos-Jiménez y Briseño-Ramírez).',
  ...
  en: {
    ...
    'dengue.note': 'Data frozen at May 2026; recent months are provisional due to reporting lag. Manuscript in preparation (De Arcos-Jiménez and Briseño-Ramírez).',
