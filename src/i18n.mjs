...
const UI = {
  es: {
    ...
    'pebm.sources_own': '<b>449 hallazgos con cifras completas</b> proceden de investigación propia del Cuerpo Académico: búsqueda en PubMed por dominio, recuperación del resumen o del texto completo de cada PMID declarado y verificación de cada cifra contra el texto real de esa fuente. Incluye 16 aplicaciones de ultrasonido de cabecera (POCUS) con métricas de meta-análisis. Se publican sensibilidad, especificidad, razones de verosimilitud, intervalos de confianza, población estudiada y la cita textual que respalda el dato.',
  ...
  en: {
    ...
    'pebm.sources_own': '<b>449 findings carry complete figures</b> and come from original research by the Research Group: PubMed searches by domain, retrieval of the abstract or full text for every declared PMID, and verification of every figure against the actual text of that source. This includes 16 point-of-care ultrasound (POCUS) applications with meta-analysis metrics. Sensitivity, specificity, likelihood ratios, confidence intervals, the population studied and the verbatim quote supporting the datum are all published.',
