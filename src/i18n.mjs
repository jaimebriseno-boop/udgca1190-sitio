...
const UI = {
  es: {
    ...
    'pebm.sources_status': '1 189 hallazgos · 236 condiciones diana',
    'pebm.sources_own': '<b>392 hallazgos con cifras completas</b> proceden de investigación propia del Cuerpo Académico: búsqueda en PubMed por dominio, recuperación del resumen o del texto completo de cada PMID declarado y verificación de cada cifra contra el texto real de esa fuente. Se publican sensibilidad, especificidad, razones de verosimilitud, intervalos de confianza, población estudiada y la cita textual que respalda el dato.',
    'pebm.sources_index': '<b>797 entradas funcionan como índice</b> hacia McGee S. <i>Evidence-Based Physical Diagnosis</i>, 3.ª ed. (Elsevier, 2012). De ellas se publica la aportación del proyecto —nomenclatura en español, descripción de la maniobra, patrón de referencia y clasificación cualitativa— junto con el localizador exacto (caja EBM y página), pero no las cifras: la selección y disposición de esas tablas es obra de su autor y su editorial, y el contenido de este sitio se publica bajo CC BY 4.0.',
  ...
  en: {
    ...
    'pebm.sources_status': '1,189 findings · 236 target conditions',
    'pebm.sources_own': '<b>392 findings carry complete figures</b> and come from original research by the Research Group: PubMed searches by domain, retrieval of the abstract or full text for every declared PMID, and verification of every figure against the actual text of that source. Sensitivity, specificity, likelihood ratios, confidence intervals, the population studied and the verbatim quote supporting the datum are all published.',
    'pebm.sources_index': '<b>797 entries work as an index</b> into McGee S. <i>Evidence-Based Physical Diagnosis</i>, 3rd ed. (Elsevier, 2012). For these we publish the project’s own contribution — Spanish nomenclature, description of the maneuver, reference standard and qualitative classification — together with the exact locator (EBM box and page), but not the figures: the selection and arrangement of those tables is the work of its author and publisher, and this site’s content is released under CC BY 4.0.',
