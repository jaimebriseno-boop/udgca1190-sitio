...
const UI = {
  es: {
    ...
    'estudio.aviso_estado': 'Protocolo en revisión académica e institucional. El reclutamiento no ha iniciado: esta página es informativa y no constituye una invitación a participar.',
  ...
  en: {
    ...
    'estudio.aviso_estado': 'The protocol is under academic and institutional review. Recruitment has not started: this page is informational and is not an invitation to participate.',
