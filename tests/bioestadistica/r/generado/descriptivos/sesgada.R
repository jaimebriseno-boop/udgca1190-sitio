...
x <- c(0.17, 0.51, 0.87, 1.24, 1.63, 2.03, 2.44, 2.88, 3.33, 3.81, 4.31, 4.83,
  5.39, 5.98, 6.6, 7.27, 7.99, 8.75, 9.59, 10.5, 11.5, 12.61, 13.86, 15.29,
  16.96, 18.97, 21.48, 24.85, 29.96, 40.94)
nivel <- 0.95
n <- length(x)
