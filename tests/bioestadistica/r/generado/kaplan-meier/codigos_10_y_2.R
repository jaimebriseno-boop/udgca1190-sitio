...
tiempo <- c(3, 5, 7, 9, 2, 4, 6, 8)
evento <- c(1, 1, 0, 1, 1, 0, 1, 1)
grupo <- c(10, 10, 10, 10, 2, 2, 2, 2)
nivel <- 0.95
tipo_ic <- "log-log"
t1 <- 4   # first time of interest; 0 = none asked for
t2 <- 8   # second time of interest; 0 = none asked for
