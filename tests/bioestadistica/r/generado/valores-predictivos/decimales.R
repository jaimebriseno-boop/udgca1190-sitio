...
sn <- 0.912; sp <- 0.877; prev <- 0.157   # sensitivity, specificity and prevalence where the test will be used (0-1)
n_d <- 137; n_nd <- 291             # diseased and non-diseased in the validation study; 0 = unknown (no CI)
nivel <- 0.95
z <- qnorm(1 - (1 - nivel) / 2)
