...
sn <- 1e-12; sp <- 0.5     # expected sensitivity and specificity (strictly between 0 and 1)
prev <- 0.5             # expected prevalence where the test will be used
w <- 0.5                   # half-width of the confidence interval (absolute precision)
nivel <- 0.8           # confidence level
