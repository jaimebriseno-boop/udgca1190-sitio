...
delta       <- 1000         # smallest difference between means that matters
sigma       <- 0.001         # common standard deviation of the outcome
alfa        <- 0.2
lateralidad <- "unilateral"   # "bilateral" or "unilateral"
poder       <- 0.5         # target power (1 - beta)
