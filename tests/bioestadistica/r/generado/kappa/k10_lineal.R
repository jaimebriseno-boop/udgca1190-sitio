...
x <- matrix(c(18, 3, 1, 0, 0, 0, 0, 0, 0, 0, 2, 20, 4, 1, 0, 0, 0, 0, 0, 0, 0, 3, 22,
  3, 1, 0, 0, 0, 0, 0, 0, 1, 4, 19, 2, 1, 0, 0, 0, 0, 0, 0, 1, 3, 25, 4, 1,
  0, 0, 0, 0, 0, 0, 1, 2, 21, 3, 1, 0, 0, 0, 0, 0, 0, 1, 4, 17, 2, 1, 0, 0,
  0, 0, 0, 0, 1, 3, 23, 3, 1, 0, 0, 0, 0, 0, 0, 1, 2, 20, 4, 0, 0, 0, 0, 0,
  0, 0, 1, 3, 16), nrow = 10, byrow = TRUE)
ponderacion <- "lineal"          # "ninguna" | "lineal" | "cuadratica"
nivel <- 0.95
